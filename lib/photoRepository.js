...
const SVG_OVERRIDE_MAP = {
  "/images/shot-01.svg": "/images/mariage/5.jpg",
  "/images/shot-02.svg": "/images/mariage/4.jpg",
  "/images/shot-03.svg": "/images/mariage/8.jpg",
  "/images/shot-04.svg": "/images/mariage/4.jpg",
  "/images/shot-05.svg": "/images/mariage/9.jpg",
  "/images/shot-06.svg": "/images/mariage/5.jpg",
};
...
function normalizePhotoRow(row) {
  ...
  // Remplacer les SVGs persistants depuis Supabase
  for (const [svg, replacement] of Object.entries(SVG_OVERRIDE_MAP)) {
...
function sortPhotos(list) {
  return [...list].sort((left, right) => {
    ...
    if (toNumber(left.sortOrder) !== toNumber(right.sortOrder)) {
      return toNumber(left.sortOrder) - toNumber(right.sortOrder);
    }
...
function getLocalPublicPhotos({ category, limit }) {
  const normalized = localPhotos.map((photo) =>
    normalizePhotoRow({
      ...photo,
      image_url: photo.src,
  ...
  const filtered = normalized.filter((photo) => {
