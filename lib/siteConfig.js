import { portfolioCategories } from "./categories";
...
export const siteConfig = {
  ...
  description:
    "Portfolio photo editorial de Jerrypicsart pour les events, la Fashion Week, les celebrities, le studio et le fashion wedding.",
  locale: "fr_FR",
  keywords: [
    "photographe",
    "portfolio photo",
    ...
    "photographe events",
    "photographe studio",
    "photographe celebrities",
    "photographe fashion wedding",
    "photo editoriale",
    "Jerrypicsart",
  ],
  navigation: [
  ...
  categoryLabels: portfolioCategories,
};
